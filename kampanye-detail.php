...
<button class="donate-btn" onclick="if(typeof openDonateModal==='function'){openDonateModal();}else{var m=document.getElementById('donateModal');if(m){m.classList.add('show');}}"><i class="fas fa-heart"></i> Donasi Sekarang</button>
</div>
</div>
